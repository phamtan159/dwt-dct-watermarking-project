...
export const mockSentence = "Okay, I will say some wrong texts.";

export const mockAssessment: SentenceAssessment = {
...
export const mockCompareResponse: CompareSoundsResponse = {
  target: "OH",
  predicted: "UH",
  difference: [
