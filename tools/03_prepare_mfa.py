...
Input:
    data/transcript/*.txt   standard words or sentences
    data/audio/*.wav        normalized audio files

Output:
    data/audio/*.txt        normalized transcript text for MFA
    custom_mfa.dict         word -> MFA-phone lexicon
"""
